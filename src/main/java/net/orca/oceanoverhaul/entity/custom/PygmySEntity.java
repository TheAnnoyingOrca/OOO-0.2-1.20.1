...
import net.orca.oceanoverhaul.entity.goals.PygmySJumpGoal;
...
public class PygmySEntity extends WaterAnimal {
    ...
    public float tilt;
    public static final int MAX_HEAD_Y_ROT = 60;
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new PygmySSwimWithPlayerGoal(this, 4.0D));
