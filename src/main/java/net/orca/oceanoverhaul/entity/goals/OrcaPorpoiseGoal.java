...
public class OrcaPorpoiseGoal extends Goal {
    ...
    public OrcaPorpoiseGoal(OrcaEntity pOrcaEntity, int pInterval) {
    ...
    public void start() {
        ...
        this.orcaentity.setDeltaMovement(this.orcaentity.getDeltaMovement().add((double)$$0.getStepX() * scale, 0.2, (double)$$0.getStepZ() * scale));
